...
DROP TABLE RESERVACAMPANIA CASCADE CONSTRAINTS;
...
DROP TABLE ORGANIZADORCAMPANIA CASCADE CONSTRAINTS;
...
DELETE FROM ORGANIZADORCAMPANIA;
DELETE FROM USUARIO;
DELETE FROM ROL;
DELETE FROM IPS;
DELETE FROM EPS;
