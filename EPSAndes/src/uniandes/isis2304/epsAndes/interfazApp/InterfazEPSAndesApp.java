		...
		try {
			...
			if(option == JOptionPane.OK_OPTION) {
				if(!combo.getSelectedItem().toString().equals("") &&!Servicio.getText().toString().equals(""))
				{
					...
					String servicio=Servicio.getText().toString();
					JOptionPane.showMessageDialog(this, "Se consult� la operaci�n con exito!", "Consulta de operacion exitosa", JOptionPane.INFORMATION_MESSAGE);
					String resultado = "Se consult� la operaci�n \n\n";
